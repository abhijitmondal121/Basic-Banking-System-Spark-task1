...
if(isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `spark_bank_1st` WHERE `slno` = $sno";
...
<div class=" jumbo-bg jumbotron jumbotron-fluid" id="home"style=" padding:180px 0px;    background-image: url('img/d2.jpg');background-size: 100%; !important" >
      ...
      <center><h1 class="x" style="color:white;">Customer Details</h1></center><br>
  ...
  <div class="row" style="color:white;">
    ...
    <table class="table" id="myTable" style=" color:white; ">
      ...
      <tbody>
        <?php 
          $sql = "SELECT * FROM `spark_bank_1st`";
          $result = mysqli_query($conn, $sql);
          $sno = 0;
          while($row = mysqli_fetch_assoc($result)){
            ...
            <td> <button class='delete btn btn-sm btn-danger' id=d".$row['slno'].">Delete</button>  </td>
          </tr>";
        } 
          ?>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this details!")) {
          console.log("yes");
          window.location = ` /bank/customerDetails.php?delete=${sno}`;
