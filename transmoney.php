...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if ($tf==''||$tt==''||$amount==''){
      ...
      $sql = "INSERT INTO `spark_bank_1sta` (`name-from`, `name-to`, `amount`) VALUES ('$tf', '$tt','$amount')";
...
<div class="container" >
    <center>    <h2 class="x my-3" style=" color:white;">Transfer Money</h2></center>
...
<div class="form-group">
    ...
    <input type="text" class="form-control"name="tf" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Name">
   
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Transfer To</label>
    <input type="text" class="form-control" name="tt" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Name">
